import os
os.system('''CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=4 python train_TFVAEGAN.py --gammaD 10 \
...
--feed_lr 0.0001 --dec_lr 0.0001 --feedback_loop 2 --a1 0.01 --a2 0.01 --model_dir ./output''')
